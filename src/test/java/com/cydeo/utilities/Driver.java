...
public class Driver {
    ...
    public static WebDriver getDriver(){
        //get() method is coming from inheritableThreadLocal class, and it is creating own driver pool and getting us available driver
        // now we have singleton approach but in multiple different threads at once
